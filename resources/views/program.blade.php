...
@section('content')
    ...
    @if(isset($programs) && $programs->count() > 0)
        <!-- Dynamic Programs from Database (Master Data) -->
        <section class="section-padding" aria-label="Program Terdaftar">
            <div class="container">
                <div class="program-section-title"><i class="bi bi-stars"></i> Modul & Program Bimbingan Aktif (LMS Master Data)</div>
                <div class="row g-4 mt-1">
                    @foreach($programs as $index => $program)
                        <div class="col-md-6 col-lg-4" data-reveal data-reveal-delay="{{ ($index % 3) * 100 }}">
                            <div class="program-card h-100 d-flex flex-column justify-content-between p-4 shadow-sm rounded-4 border">
                                <div>
                                ...
                                <div class="pt-3 border-top mt-3">
                                    ...
                                    <a href="https://wa.me/6285786689008?text={{ urlencode('Assalamualaikum, saya ingin berkonsultasi mengenai program ' . $program->name) }}"
