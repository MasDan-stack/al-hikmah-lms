...
@section('description', 'Biaya dan Paket Belajar AL-HIKMAH — Informasi transparan tentang pilihan pendampingan belajar
    Al-Qur\'an.')
                    ...
                    <div class="biaya-card">
                        <div class="biaya-card-left">
                            ...
                            <div class="biaya-info">
                                ...
                                <span class="biaya-catatan">✔ Satu kali pembayaran untuk administrasi & assessment
                                    awal</span>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6" data-reveal>
                    <div class="paket-card">
                        ...
                        <div class="paket-card-body">
                            ...
                            <div class="paket-detail"><span class="detail-label">Durasi</span><span class="detail-value">90
                                    menit</span></div>
                            <div class="paket-detail"><span class="detail-label">Pendampingan</span><span
                                    class="detail-value">Private (1:1)</span></div>
                            <a href="https://wa.me/6285786689008" class="btn btn-outline-custom w-100"
                                target="_blank">Konsultasikan</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-reveal data-reveal-delay="100">
                    <div class="paket-card paket-popular">
                        ...
                        <div class="paket-card-body">
                            ...
                            <div class="paket-detail"><span class="detail-label">Pendampingan</span><span
                                    class="detail-value">Private (1:1)</span></div>
                            <a href="https://wa.me/6285786689008" class="btn btn-primary-custom w-100"
                                target="_blank">Konsultasikan</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-reveal data-reveal-delay="200">
                    <div class="paket-card">
                        <div class="paket-card-header"><span class="paket-name">Premium</span><span class="paket-badge">12x
                                / bulan</span></div>
                        <div class="paket-card-body">
