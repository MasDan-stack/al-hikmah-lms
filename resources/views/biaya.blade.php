...
@section('content')
                    ...
                    <div class="biaya-card">
                        <div class="biaya-card-left">
                            ...
                            <div class="biaya-info"><span class="biaya-label">Biaya Pendaftaran</span>
                                <div class="biaya-harga">Rp <span class="biaya-angka">150.000</span></div><span
                                    class="biaya-catatan">✔ Satu kali pembayaran untuk administrasi & assessment
                                    awal</span>
                            </div>
                        </div>
                        <div class="biaya-card-right"><span class="biaya-badge">Sekali Bayar</span><small
                                class="biaya-subnote">*Belum termasuk paket bulanan</small></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if(isset($programs) && $programs->count() > 0)
        ...
        <section class="section-padding bg-light border-bottom border-top" aria-label="Paket Terdaftar">
            <div class="container">
                <div class="program-section-title text-center mb-4"><i class="bi bi-award text-success me-2"></i>Pilihan Program & Investasi Belajar (LMS Master Data)</div>
                        ...
                        <div class="col-lg-4 col-md-6" data-reveal data-reveal-delay="{{ ($index % 3) * 100 }}">
                            <div class="paket-card {{ $index === 1 ? 'paket-popular' : '' }} h-100 d-flex flex-column justify-content-between">
                                ...
                                <div class="px-3 pb-3 mt-3">
                                    <a href="{{ wa_url('Assalamualaikum, saya ingin menanyakan mengenai paket biaya program ' . $program->name) }}"
    ...
    <!-- Paket Belajar Standard Template -->
    <section class="section-padding section-alt" aria-label="Paket Standard">
        <div class="container">
            <div class="program-section-title text-center mb-4"><i class="bi bi-journal-check text-success me-2"></i>Paket Pendampingan Rutin Bulanan</div>
            <div class="row g-4 justify-content-center">
                <!-- Paket Basic -->
                <div class="col-lg-4 col-md-6" data-reveal>
                    <div class="paket-card">
                        <div class="paket-card-header"><span class="paket-name">Basic</span><span class="paket-badge">4x
                                / bulan</span></div>
                        <div class="paket-card-body">
                            <div class="paket-price"><span class="price-amount">Rp 400.000</span><span
                                    class="price-period">/ bulan</span></div>
                            <div class="paket-detail"><span class="detail-label">Pertemuan</span><span
                                    class="detail-value">4x / bulan (1x/minggu)</span></div>
                            <div class="paket-detail"><span class="detail-label">Durasi</span><span
                                    class="detail-value">90 menit</span></div>
                            <div class="paket-detail"><span class="detail-label">Pendampingan</span><span
                                    class="detail-value">Private (1:1)</span></div>
                            <a href="{{ wa_url('Assalamualaikum, saya ingin berkonsultasi mengenai Paket Basic (4x/bulan)') }}"
                                class="btn btn-outline-custom w-100" target="_blank">Konsultasikan</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-reveal data-reveal-delay="100">
                    <div class="paket-card paket-popular">
                        ...
                        <div class="paket-card-header"><span class="paket-name">Standard</span><span
                                class="paket-badge popular">8x / bulan</span></div>
                        <div class="paket-card-body">
                            <div class="paket-price"><span class="price-amount">Rp 800.000</span><span
                                    class="price-period">/ bulan</span></div>
                            <div class="paket-detail"><span class="detail-label">Pertemuan</span><span
                                    class="detail-value">8x / bulan (2x/minggu)</span></div>
                            <div class="paket-detail"><span class="detail-label">Durasi</span><span
                                    class="detail-value">90 menit</span></div>
                            <div class="paket-detail"><span class="detail-label">Pendampingan</span><span
                                    class="detail-value">Private (1:1)</span></div>
                            <a href="{{ wa_url('Assalamualaikum, saya ingin berkonsultasi mengenai Paket Standard (8x/bulan)') }}"
                                class="btn btn-primary-custom w-100" target="_blank">Konsultasikan</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-reveal data-reveal-delay="200">
                    <div class="paket-card">
                        <div class="paket-card-header"><span class="paket-name">Premium</span><span
                                class="paket-badge">12x / bulan</span></div>
                        <div class="paket-card-body">
                            <div class="paket-price"><span class="price-amount">Rp 1.200.000</span><span
                                    class="price-period">/ bulan</span></div>
                            <div class="paket-detail"><span class="detail-label">Pertemuan</span><span
                                    class="detail-value">12x / bulan (3x/minggu)</span></div>
                            <div class="paket-detail"><span class="detail-label">Durasi</span><span
                                    class="detail-value">90 menit</span></div>
                            <div class="paket-detail"><span class="detail-label">Pendampingan</span><span
                                    class="detail-value">Private (1:1)</span></div>
                            <a href="{{ wa_url('Assalamualaikum, saya ingin berkonsultasi mengenai Paket Premium (12x/bulan)') }}"
                                class="btn btn-outline-custom w-100" target="_blank">Konsultasikan</a>
                        </div>
                    </div>
                </div>
