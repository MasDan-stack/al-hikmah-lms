...
@section('title', 'Edit Artikel Blog | Admin AL-HIKMAH')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1 text-heading">
                <i class="bi bi-pencil-square text-success me-2"></i>Edit Artikel Blog
            </h3>
            <p class="text-muted small mb-0">Perbarui konten, status, atau media gambar artikel "{{ $article->title }}".</p>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="excerpt" id="excerpt" rows="2" class="form-control rounded-3">{{ old('excerpt', $article->excerpt) }}</textarea>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card border border-secondary-subtle rounded-4 p-3 mb-4 bg-light-subtle">
                            ...
                            <div class="mb-3 text-center">
                                <img id="coverPreview" src="{{ $article->cover_url }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="cover_caption" id="cover_caption" class="form-control form-control-sm rounded-2" 
                                       value="{{ old('cover_caption', $article->cover_caption) }}">
                            </div>
                        </div>
                        ...
                        <div class="card border border-secondary-subtle rounded-4 p-3 mb-4 bg-light-subtle">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="published_at" id="published_at" class="form-control form-control-sm" 
                        ...
                        <div class="card border border-secondary-subtle rounded-4 p-3 bg-light-subtle">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row g-2 border rounded-3 p-2 bg-white" style="max-height: 180px; overflow-y: auto;">
                                    ...
                                    @empty
                                        <div class="col-12 text-muted small text-center py-2">Belum ada tag.</div>
                                    @endforelse
                                </div>
                            </div>
                        </div>
