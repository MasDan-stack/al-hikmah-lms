...
@section('title', 'Daftar Akun Baru | AL-HIKMAH LMS')
...
<form method="POST" action="{{ route('register') }}" class="needs-validation" novalidate>
    ...
    @else
        <div class="mb-3">
            <label class="form-label fw-semibold text-secondary small">Daftar Sebagai</label>
            <div class="row g-2">
                <div class="col-6">
    ...
    <div class="mb-3">
        <label for="phone" class="form-label fw-semibold text-secondary small">No. WhatsApp / HP</label>
        <div class="input-group">
