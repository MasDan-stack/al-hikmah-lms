    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="admin-sidebar-nav">
                <div class="text-xs text-uppercase fw-bold text-muted px-3 mb-2">Portal Mentor</div>
        ...
        <div class="admin-main">
            <header class="admin-header">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="fw-bold mb-0 text-primary">@yield('header', 'Dashboard Mentor')</h5>
                        <small class="text-muted">@yield('subheader', 'Selamat datang di Panel Pendamping AL-HIKMAH')</small>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="admin-user-badge">
                        ...
                        <span>{{ auth()->user()->name ?? 'Ustaz/Ustazah' }}</span>
                    </div>
                </div>
            </header>
