    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="admin-sidebar-nav">
                <div class="admin-nav-section-title"><i class="bi bi-grid-fill me-1"></i> Ringkasan Utama</div>
                ...
                <a href="{{ route('admin.performance.mentors.index') }}"
                ...
                <div class="admin-nav-section-title mt-2"><i class="bi bi-person-plus-fill me-1"></i> Rekrutmen Guru</div>
                ...
                <div class="admin-nav-section-title mt-2"><i class="bi bi-mortarboard-fill me-1"></i> Manajemen Akademik</div>
                ...
                <div class="admin-nav-section-title mt-2"><i class="bi bi-trophy-fill me-1"></i> Gamifikasi & Badges</div>
                ...
                <div class="admin-nav-section-title mt-2"><i class="bi bi-newspaper me-1"></i> Konten & Publikasi</div>
                <a href="{{ route('admin.blog.index') }}"
                    class="admin-nav-item {{ request()->routeIs('admin.blog.index') || request()->routeIs('admin.blog.create') || request()->routeIs('admin.blog.edit') ? 'active' : '' }}">
                    <i class="bi bi-newspaper"></i> Artikel Blog CMS
                </a>
                <a href="{{ route('admin.blog.categories.index') }}"
                    class="admin-nav-item {{ request()->routeIs('admin.blog.categories.*') ? 'active' : '' }}">
                    <i class="bi bi-tags-fill"></i> Kategori Blog
                </a>
                <a href="{{ route('admin.blog.tags.index') }}"
                    class="admin-nav-item {{ request()->routeIs('admin.blog.tags.*') ? 'active' : '' }}">
                    <i class="bi bi-hash"></i> Tags Taksonomi
                </a>
                <a href="{{ route('admin.blog.trash') }}"
                    class="admin-nav-item {{ request()->routeIs('admin.blog.trash') ? 'active' : '' }}">
                    <i class="bi bi-trash"></i> Tong Sampah Blog
                </a>
            ...
            <header class="admin-header">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="header-left-title">
                        <h5 class="fw-bold mb-0 header-page-title">@yield('header', 'Panel Administrator')</h5>
                        <small class="text-muted header-page-subtitle">@yield('subheader', 'Sistem Manajemen Pembelajaran Terpadu AL-HIKMAH')</small>
                    </div>
                </div>
                ...
                <div class="header-actions-group">
                    ...
                    @php
                        $user = auth()->user();
                        $nameParts = explode(' ', trim($user->name ?? 'Admin'));
                    ...
                    <div class="dropdown">
                        <button class="user-profile-toggle dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="d-none d-md-block user-profile-info">
                                <div class="user-profile-name">{{ $user->name ?? 'Administrator' }}</div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-premium shadow-lg">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-1">
                                        ...
                                        <div class="overflow-hidden">
                                            ...
                                            <span class="badge bg-success-subtle text-success border border-success-subtle rounded-pill" style="font-size: 0.62rem;">
                                                <i class="bi bi-shield-lock-fill me-1"></i>{{ $user->role?->label ?? 'Administrator' }}
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <a class="dropdown-item dropdown-item-premium" href="{{ route('admin.settings.index') }}">
                                    <i class="bi bi-gear-fill"></i> Pengaturan Website
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item dropdown-item-premium" href="{{ route('admin.users.index') }}">
