                    ...
                    <div class="row justify-content-center mt-4">
                        <div class="col-md-8 col-lg-6">
                            <div class="input-group input-group-lg shadow-sm rounded-pill overflow-hidden border">
                                <span class="input-group-text border-0 ps-4 text-muted"><i class="bi bi-search"></i></span>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="accordion custom-accordion" id="faqAccordion">
                    ...
                    <div class="accordion-item shadow-sm rounded-4 mb-3 border-0 faq-card" data-category="jadwal">
                        <h3 class="accordion-header">
                            <button class="accordion-button rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq1" aria-expanded="true">
                    ...
                    <div class="accordion-item shadow-sm rounded-4 mb-3 border-0 faq-card" data-category="umum">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq2" aria-expanded="false">
                    ...
                    <div class="accordion-item shadow-sm rounded-4 mb-3 border-0 faq-card" data-category="jadwal">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq3" aria-expanded="false">
                    ...
                    <div class="accordion-item shadow-sm rounded-4 mb-3 border-0 faq-card" data-category="biaya">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq4" aria-expanded="false">
                    ...
                    <div class="accordion-item shadow-sm rounded-4 mb-3 border-0 faq-card" data-category="jadwal">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq5" aria-expanded="false">
                    ...
                    <div class="accordion-item shadow-sm rounded-4 mb-3 border-0 faq-card" data-category="portal">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq6" aria-expanded="false">
                    ...
                    <div class="accordion-item shadow-sm rounded-4 mb-3 border-0 faq-card" data-category="portal">
                        <h3 class="accordion-header">
                            <button class="accordion-button collapsed rounded-4 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq7" aria-expanded="false">
                ...
                <div id="noFaqResults" class="text-center py-5 d-none rounded-4 card border-0">
                    <i class="bi bi-search fs-1 text-muted d-block mb-2"></i>
                    <h5 class="fw-bold">Pertanyaan Tidak Ditemukan</h5>
        ...
        <!-- HELP BANNER -->
        <div class="mt-5 p-4 p-md-5 rounded-4 card border-0 shadow-sm text-center" data-reveal>
            <div class="row align-items-center">
                <div class="col-md-8 text-md-start mb-3 mb-md-0">
                    <h4 class="fw-bold mb-1">Punya Pertanyaan Lain yang Belum Terjawab?</h4>
